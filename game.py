...
\"rock, paper, scissors, lizard, Spock.\" Choose one: ")
...
# Here I gave the player the option of playing again. If the player responds: "yes" the
# function defined "game" repeats. If the response is "no" or anything else the program 
# ends. Once again I used the .lower() function to make sure that the program can read 
# the input regardless of case.
	print
	...
	if answer == "yes":
		...
		print
		print "I'm sorry I did not understand. Please play again soon."
		print
